...
$copies = @(
    ...
    @{ Source = (Join-Path $repoRoot "docs/RELEASE-NOTES-$Version.md"); Target = "en/RELEASE-NOTES.md" },
    ...
    @{ Source = (Join-Path $repoRoot "docs/pt-BR/NOTAS-DA-VERSAO-$Version.md"); Target = "pt-BR/NOTAS-DA-VERSAO.md" },
