...
function localizeTemplate(template, locale) {
  const replacements = locale === 'pt-BR' ? new Map([
    ...
    ['PRODUCT TRUTH · v0.4.1 · LOCAL FIRST', 'PRODUTO REAL · v0.4.1 · LOCAL PRIMEIRO'],
    ['ONE .ABLX · NO ACCOUNT · NO TELEMETRY · v0.4.1', 'UM .ABLX · SEM CONTA · SEM TELEMETRIA · v0.4.1'],
    ['From locator<br><span>to stage.</span>', 'Do localizador<br><span>ao palco.</span>'],
    ['Run the set, follow every section and keep lyrics or chords visible in the browser.', 'Conduza o set, acompanhe cada seção e mantenha letras ou cifras visíveis no navegador.'],
    ...
    ['Run the set', 'Conduza o set'],
    ['Songs, sections, quantization, click, refresh and guarded transport.', 'Músicas, seções, quantização, clique, atualização e transporte protegido.'],
    ['03 · Stage', '03 · Palco'],
