# Release checklist — Ableton RC Setlist 0.6.0
...
- [ ] `Ableton-RC-Setlist-0.6.0.ablx` installs without errors.
- [ ] With clean data, the first **Start** creates the default profile and starts the server without a persistence error.
- [ ] **Extensions > Ableton RC Setlist** opens the correct panel and shows version 0.6.0.
