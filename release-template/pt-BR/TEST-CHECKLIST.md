# Checklist de lançamento — Ableton RC Setlist 0.6.0
...
- [ ] `Ableton-RC-Setlist-0.6.0.ablx` instala sem erro.
- [ ] Em dados limpos, o primeiro **Iniciar** cria o perfil padrão e sobe o servidor sem erro de persistência.
- [ ] **Extensions > Ableton RC Setlist** abre o painel correto e mostra a versão 0.6.0.
