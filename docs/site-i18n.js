(function rcSetlistSiteI18n(globalScope) {
  ...
  const copy = {
    en: {
      ...
      navSource: 'Source',
      language: 'Language',
      heroEyebrow: 'Ableton Live extension · v0.7.0',
      ...
      truthful: 'The interface mirrors the functions that ship in v0.7.0. No fictional dashboard metrics and no show content bundled with the extension.',
      ...
      installBody: 'Ableton RC Setlist requires Ableton Live 12.4.5+ Suite (Beta) with Extensions support and the bundled RC Bridge Control Surface (a fork of AbletonOSC; a stock AbletonOSC also works). Windows is validated; macOS remains experimental for this release.',
      installGuide: 'Installation guide',
      releaseNotes: 'What is new',
      check1: 'Install the single Ableton-RC-Setlist-0.7.0.ablx package',
    ...
    'pt-BR': {
      ...
      language: 'Idioma',
      heroEyebrow: 'Extensão para Ableton Live · v0.7.0',
      ...
      truthful: 'A interface mostra as funções que já fazem parte da v0.7.0. Sem métricas fictícias e sem conteúdo de shows incluído na extensão.',
      ...
      release: 'Versão 0.7.0',
      installTitle: 'Instale, ensaie, verifique.',
      installBody: 'O Ableton RC Setlist precisa do Ableton Live 12.4.5+ Suite (Beta) com suporte a Extensions e da Control Surface RC Bridge, que vem junto (um fork do AbletonOSC; um AbletonOSC comum também funciona). O Windows está validado; o macOS segue experimental nesta versão.',
      installGuide: 'Guia de instalação',
      releaseNotes: 'O que há de novo',
      check1: 'Instale o único pacote Ableton-RC-Setlist-0.7.0.ablx',
