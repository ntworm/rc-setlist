(function rcSetlistSiteI18n(globalScope) {
  ...
  const copy = {
    en: {
      ...
      navSource: 'Source',
      language: 'Language',
      heroEyebrow: 'Ableton Live extension · v0.4.0',
      ...
      truthful: 'The interface mirrors the functions that ship in v0.4.0. No fictional dashboard metrics and no show content bundled with the extension.',
      ...
      feature4Body: 'See song, section, loop progress, timecode, bar/beat, BPM and click state at a glance.',
      feature5Label: '05 · SHOW DATA',
      feature5Title: 'Profiles and export',
      feature5Body: 'Separate shows by profile, preserve local ordering and lyrics, and export the visible tracklist as CSV.',
      ...
      check1: 'Install the single Ableton-RC-Setlist-0.4.0.ablx package',
    ...
    'pt-BR': {
      ...
      description: 'Ableton RC Setlist é uma extensão source-available para Ableton Live com músicas guiadas por localizadores, letras sincronizadas e controles protegidos para o palco.',
      ...
      language: 'Idioma',
      heroEyebrow: 'Extensão para Ableton Live · v0.4.0',
      heroLede: 'Transforme localizadores do Arrangement em um setlist real para operação, uma tela de letras sincronizadas e controles protegidos para o palco — tudo rodando localmente entre o Ableton Live e o navegador.',
      ...
      seeShow: 'Veja o show.',
      runSet: 'Conduza o set.',
      productIntro: 'O produto permanece ancorado no Ableton Live. O navegador entrega ao operador e ao performer a informação de que cada um precisa, sem inventar uma segunda timeline.',
      performanceAlt: 'Interface Performance com música atual e próxima, seção, letras, timecode, compasso, BPM e clique',
      performanceBody: 'Estado do show em alto contraste, indicações atuais e seguintes, letras sincronizadas, timecode, compasso, tempo e clique.',
      ...
      stageBody: 'Navegação por músicas e seções, transporte protegido, quantização, clique, atualização, ferramentas, bloqueio e retorno ao vivo.',
      ...
      workflowAlt: 'Fluxo dos localizadores ao palco: marque o Arrangement, conduza o set e acompanhe o show',
      builtFor: 'Feito para ensaio e palco',
      liveSet: 'Um Live Set que pode ser lido como um show.',
      truthful: 'A interface mostra as funções que já fazem parte da v0.4.0. Sem métricas fictícias e sem conteúdo de shows incluído na extensão.',
      ...
      feature2Body: 'Anterior e Próxima exigem um toque deliberado. O retorno de saltos e quantização aguarda confirmação do Live.',
      ...
      feature4Title: 'Indicações atuais e seguintes',
      feature4Body: 'Veja música, seção, progresso do loop, timecode, compasso, BPM e estado do clique de uma vez.',
      feature5Label: '05 · DADOS DO SHOW',
      feature5Title: 'Perfis e exportação',
      feature5Body: 'Separe shows por perfil, preserve ordenação e letras locais e exporte o repertório visível como CSV.',
      feature6Label: '06 · REDE',
      feature6Title: 'Acesso local pelo navegador',
      feature6Body: 'Abra o Controle de Palco ou a tela Performance somente leitura em um notebook, tablet ou celular confiável na LAN.',
      ...
      release: 'Versão 0.4.0',
      installTitle: 'Instale, ensaie, verifique.',
      installBody: 'O Ableton RC Setlist requer Ableton Live 12.4.5+ Suite (Beta) com suporte a Extensions e a Control Surface externa AbletonOSC. Windows está validado; macOS permanece experimental nesta versão.',
      installGuide: 'Guia de instalação',
      check1: 'Instale o único pacote Ableton-RC-Setlist-0.4.0.ablx',
      check2: 'Instale o AbletonOSC separadamente pelo projeto original',
      check3: 'Inicie o servidor local em Extensions no Live',
      check4: 'Abra Controle de Palco ou Performance em uma LAN confiável',
      check5: 'Ensaie transporte, indicações, clique e letras antes do uso no palco',
      license: 'Licença:',
