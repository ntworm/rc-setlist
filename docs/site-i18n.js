(function rcSetlistSiteI18n(globalScope) {
  ...
  const copy = {
    ...
    'pt-BR': {
      ...
      feature4Body: 'Veja duração da música e do setlist, seção, progresso do loop, compasso estável, BPM e estado do clique de uma vez.',
      feature5Label: '05 · DADOS DO SHOW',
      feature5Title: 'Setlists salvos e exportação',
      feature5Body: 'Mantenha vários setlists dentro do Live Set atual, preserve ordem e letras, recupere perfis excluídos e exporte CSV.',
