(function rcSetlistSiteI18n(globalScope) {
  ...
  const copy = {
    en: {
      ...
      navSource: 'Source',
      language: 'Language',
      heroEyebrow: 'Ableton Live extension · v0.5.0',
      ...
      truthful: 'The interface mirrors the functions that ship in v0.5.0. No fictional dashboard metrics and no show content bundled with the extension.',
      ...
      check1: 'Install the single Ableton-RC-Setlist-0.5.0.ablx package',
    ...
    'pt-BR': {
      ...
      language: 'Idioma',
      heroEyebrow: 'Extensão para Ableton Live · v0.5.0',
      ...
      truthful: 'A interface mostra as funções que já fazem parte da v0.5.0. Sem métricas fictícias e sem conteúdo de shows incluído na extensão.',
      ...
      check1: 'Instale o único pacote Ableton-RC-Setlist-0.5.0.ablx',
